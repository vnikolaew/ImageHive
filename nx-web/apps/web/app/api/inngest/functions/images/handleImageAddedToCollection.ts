...
const FUNCTION_ID = `image-addedToCollection`;

const EVENT_NAME: keyof Events = `image/image.addedToCollection`;

const POPULARITY_SCORE_KEY = `popularity_score`;

export const handleImageAddedToCollection = inngest.createFunction(

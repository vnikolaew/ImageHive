            ...
            <div className="flex items-center gap-6 mt-4">
               <a title={`Twitter`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-neutral-500 cursor-pointer hover:fill-primary transition-colors duration-200">
                     <path
               ...
               <a title={`Youtube`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-neutral-500 cursor-pointer hover:fill-red-500 transition-colors duration-200">
                     <path
               ...
               <a title={`Facebook`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-neutral-700 cursor-pointer hover:fill-blue-500 transition-colors duration-200">
                     <path
               ...
               <a title={`LinkedIn`}>
                  <Linkedin
                     className={`text-neutral-500 stroke-2 cursor-pointer hover:fill-[#0077B5] hover:text-[#0077B5] transition-colors duration-200`}
                     size={24} />
               </a>
            </div>

            ...
            <div className="flex items-center gap-6 mt-4">
               <a>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-blue-400 cursor-pointer hover:opacity-80 transition-colors duration-200">
                     <path
               ...
               <a>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-red-500 cursor-pointer hover:opacity-80 transition-colors duration-200">
                     <path
               ...
               <a>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-blue-700 cursor-pointer hover:opacity-80 transition-colors duration-200">
                     <path

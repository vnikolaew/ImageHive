...
const Footer = ({}: FooterProps) => {
   return (
      <section className={`mt-24 lg:mt-32 w-full p-12 border-t-[1px] rounded-b-xl grid grid-cols-3 gap-8`}>
         ...
         <nav className="flex h-fit items-start flex-col justify-between px-3 gap-3 text-md leading-none">
            ...
            <div className="flex items-center gap-8 mt-4">
               <a>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                       className="fill-current cursor-pointer hover:fill-neutral-600 transition-colors duration-200">
                     <path

...
const ResetPasswordEmail = ({ url, username }: ResetPasswordEmailProps) => {
         ...
         >
            <Section className={`w-4/5 flex flex-col items-start`}>
               ...
               <Text className={`!mt-2 text-lg`}>
                  We received a request to change your password on {APP_NAME}.
               </Text>
               <Text className={`!mt-2 !mb-0 text-lg`}>
                  To reset your {APP_NAME} password, please click this link:
               </Text>
               <Text className={`!my-0 text-lg`}>
               ...
               <Section className={`text-base !mt-8`}>
                  <Text className={`!my-0 !mt-4 text-neutral-500`}>© {new Date().getFullYear()} ImageHive</Text>
                  <Text className={`!my-0`}>
